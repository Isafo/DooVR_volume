...
menuBox::menuBox(float x, float y, float z, float dX, float dY, float dZ, int tX, int tY, int tXLength, int tYLength) {
	...
	GLfloat vertex_array_data[] = {
		...
		-dX / 2.0f, -dY / 2.0f,  dZ / 2.0f,				0.0f, -1.0f, 0.0f,		0.8333f, 1.0f,		//1 - 8
		dX / 2.0f,  -dY / 2.0f,  dZ / 2.0f,				0.0f, -1.0f, 0.0f,		0.8333f, 0.8333f,	//2 - 9
		-dX / 2.0f, -dY / 2.0f, -dZ / 2.0f,				0.0f, -1.0f, 0.0f,		1.0f, 0.8333f,		//5 - 10
