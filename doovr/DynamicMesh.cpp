...
void DynamicMesh::generateMC(ScalarField _sf) {
	...
	xyz[6][0] = isoCache[layerIndex][y][z].cornerPoint[0] = (float)((x + 1 - (_sf.res[0] / 2)) / ((float)(_sf.res[0] / 2)))*_sf.dim[0];
	xyz[6][1] = isoCache[layerIndex][y][z].cornerPoint[1] = (float)((y + 1 - (_sf.res[1] / 2)) / ((float)(_sf.res[1] / 2)))*_sf.dim[1];
	xyz[6][2] = isoCache[layerIndex][y][z].cornerPoint[2] = (float)((z + 1 - (_sf.res[2] / 2)) / ((float)(_sf.res[2] / 2)))*_sf.dim[2];
