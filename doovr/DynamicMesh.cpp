...
void DynamicMesh::createBuffers() {
	...
	glBufferData(GL_ARRAY_BUFFER,
		(MAX_NR_OF_VERTICES)*sizeof(bufferData), NULL, GL_STREAM_DRAW);

	vertexP = (bufferData*)glMapBufferRange(GL_ARRAY_BUFFER, 0, sizeof(bufferData) *MAX_NR_OF_VERTICES,
	...
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE,
		sizeof(bufferData), (void*)(6 * sizeof(GLfloat))); // normals
...
void DynamicMesh::updateOGLData()
{
	...
	vertexP = (bufferData*)glMapBufferRange(GL_ARRAY_BUFFER, 0, sizeof(bufferData)*(vertexCap),
		GL_MAP_WRITE_BIT | GL_MAP_INVALIDATE_BUFFER_BIT | GL_MAP_UNSYNCHRONIZED_BIT);
	...
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE,
		sizeof(bufferData), (void*)(3 * sizeof(GLfloat))); // normals
	glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE,
		sizeof(bufferData), (void*)(6 * sizeof(GLfloat))); // selected
